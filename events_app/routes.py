...
def create():
    ...
    if request.method == 'POST':
        ...
        new_event = Event(title=new_event_title, description=new_event_description, date_and_time=date_and_time, event_type=new_event_type)
...
@main.route('/event/<int:event_id>', methods=['POST'])
def rsvp(event_id):
    """RSVP to an event."""
    event = Event.query.get_or_404(event_id)
...
def guest_detail(guest_id):
    """Show a single guest and the events they're attending."""
